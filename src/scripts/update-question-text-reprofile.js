...
async function updateQuestionText() {
  console.log("🚀 UPDATING LIVE QUESTION TEXT (Removing specific hint)...");
  try {
    ...
    if (q9 && q9.id === "q9") {
      q9.question = "Write a function `find_max(numbers)` that returns the largest number in a list of integers. (Don't use built-in functions)";
      
      await updateDoc(pythonRef, {
        "finalQuiz.questions": questions
      });
      console.log("✅ Successfully updated live question text (No more max() hint)!");
