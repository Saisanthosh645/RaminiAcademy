...
async function updatePythonQuiz() {
  console.log("🚀 Updating Python Final Quiz in Firestore...");
  try {
    const pythonRef = doc(db, "courses", "python-zero-hero");
    await updateDoc(pythonRef, {
      finalQuiz: finalQuiz
    });
    console.log("✅ Successfully added coding question to Python final quiz!");
    console.log("🎉 Please refresh your browser to see the 9th question.");
  } catch (error) {
