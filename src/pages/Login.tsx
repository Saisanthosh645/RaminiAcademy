...
const Login = () => {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      toast({ title: "Reset email sent!", description: `Check your inbox at ${email} for the reset link.` });
    } catch {
      toast({ title: "Error", description: "Failed to send reset email. Check your email address.", variant: "destructive" });
    } finally {
