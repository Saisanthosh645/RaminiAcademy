...
import { GraduationCap, Mail, Lock, User, Loader2, Eye, EyeOff, CheckCircle2, AlertCircle } from "lucide-react";
import { useToast } from "@/hooks/use-toast";
import { LoadingScreen } from "@/components/LoadingScreen";
import { validatePassword, getPasswordStrengthColor } from "@/lib/password-validator";
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="w-full max-w-md">
        <div className="glass-card rounded-2xl p-8 space-y-6">
          ...
          >
            ...
            {isGooglePending ? <Loader2 className="w-4 h-4 animate-spin mr-2" /> : null}
            Sign up with Google
          </Button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {password && (
                <>
                  ...
                  <p className={`text-xs capitalize font-medium ${
                    passwordValidation.strength === "very-strong" || passwordValidation.strength === "strong"
                      ? "text-emerald-500"
                  ...
                  {passwordValidation.feedback.length > 0 && (
                    <div className="bg-amber-500/10 border border-amber-500/20 rounded p-3 space-y-1">
                  ...
                  {passwordValidation.passed && (
                    <div className="flex gap-2 text-xs text-emerald-600 items-center">
            ...
            <Button
              ...
              disabled={isPending || isLoading || !passwordValidation.passed}
            >
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3 flex gap-3">
            ...
            <p className="text-xs text-blue-900">
              <strong>Note:</strong> You'll need to verify your email after signup to access your account.
            </p>
          </div>
